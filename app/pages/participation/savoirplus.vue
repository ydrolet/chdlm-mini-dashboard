  ...
  <div>
    <NuxtLayout>
      ...
      <template #content>
        ...
        <p>
          Ces inconvénients des feuilles de calculs peuvent compliquer la compilation des données présentes dans toutes les feuilles. La compilation est nécessaire lorsque l'on veut avoir une vue globale de la participation, par exemple à des fins statistiques. Pour réaliser cette compilation, un script extrait automatiquement les données dans toutes les feuilles de temps. Pour que l'extraction fonctionne bien, la disposition et structure dans chacune des Googles Sheets doit être correcte. Le script effectue des vérifications et avertit lorsqu'il y a des problèmes de disposition et structure, pour qu'ensuite des corrections manuelles soient apportées.
        </p>
        <p>
