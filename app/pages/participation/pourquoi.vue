<template>
  <div>
    <NuxtLayout>
      <template #title>Pourquoi consulter son bilan de participation ?</template>

      <template #content>
        <p>
          Tout comme un propriétaire d'une maison individuelle ou d'un bloc d'appartements, les membres dans une coopérative d'habitation ont des responsabilités importantes pour s'assurer du bon fonctionnement de notre environnement. L'implication doit être prise au sérieux.
          <NuxtLink
            class="inline-hyperlink"
            to="https://cooperativehabitation.coop/habiter-en-coop/"
          >Une coopérative d'habitation est une entreprise privée, à but non lucratif, dont nous sommes toutes et tous responsables.</NuxtLink>
          La participation des membres est <b>cruciale</b>. Si ces responsabilités ne sont pas prises en main, nous devons engager des gens qui s'en occuperont, donc des coûts qui s'additionneraient aux loyers. Idéalement, tous les membres devraient répondre aux besoins de la coopérative à part égale. Pour atteindre cet idéal, il faut être structuré. L'enregistrement des heures de participation permet entre autres d'avoir une mesure pour aider à la répartition des tâches. L'objectif de chacun n'est pas de simplement « faire des heures ». L'objectif est de répondre aux besoins de notre coop.
        </p>
        <p>
